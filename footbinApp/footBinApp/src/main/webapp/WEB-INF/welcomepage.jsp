...
<div class="container" style="background-color: black">
    <div class="row" style="background-color: black">
        <div class="col-sm" style="background-color: black">
            <div class="circle" > <a href="/footBinApp_war_exploded/about"> About </a> </div>
        </div>
        <div class="col-sm" style="background-color: black">
            <div class="circle"> <a href="/footBinApp_war_exploded/players"> Players </a> </div>
        </div>
        <div class="col-sm" style="background-color: black">
            <div class="circle"> <a href="/naive"> Build </a> </div>
        </div>
    </div>
</div>
